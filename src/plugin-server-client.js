...
async function fetchPluginServerCategory(config, category = {}, fetchImpl = fetch) {
  const payload = await postPluginServer(config, '/catvod/category', {
    extend: category?.extend || {},
